 ...
 * @returns 
 */
export function getPlaylist(order: string = 'hot', cat: string = '全部', limit: number = 50, offset: number = 0) {
	return request({
		url: '/top/playlist',
		params: {
			order: order,
 ...
 * @returns 
 */
export function getTopPlaylist(order: string = 'hot', cat: string = '全部', limit: number = 50, offest: number = 0) {
	return request({
		url: "/top/playlist",
		params: {
			order,
